...
# ---------------------------------------------------------
# KGT v5.1 – Enhanced Fractal Counter-Vortex Model (Grok-adjusted)
# Only one modification from v5.0:
# counter_scale_newton increased from 1.6 → 2.0
# --------------------------------------------------------
...
# *** Grok Adjustment ***
counter_scale_newton = 2.0      # Stronger Newton damping (v5.0 had 1.6)
...
# Output
# ---------------------------------------------------------
print("\n--- KGT v5.1 – Grok-Adjusted Andromeda Fit ---\n")
...
plt.plot(r, v_sim, label="KGT v5.1", linewidth=3, color="navy")
...
plt.title("Andromeda Rotation Curve – Königsmann-Theory v5.1")
plt.grid(alpha=0.4)
plt.legend()
plt.tight_layout()
plt.show()
