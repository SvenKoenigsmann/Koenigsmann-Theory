...
# ============================================================================
# KGT v4.13 — Stabilized Core Dynamics (Pre-5.0 Release)
# ============================================================================
...
# ============================================================================
# PHYSICALLY STABILIZED PARAMETERS
# ============================================================================
...
# Stabilized Φ-resonance
PHI_QUANTUM = 2.4
PHI_AMPLITUDE = 1.2       # reduced from 2.85
PHI_WIDTH = 6.0           # wider = lower core influence
...
def vortex_distribution(r):
    """Fractal vortex with soft normalization (stabilized)"""
    ...
    # stabilized: prevent over-amplification
    return total / (max_val * 3.0) if max_val > 0 else total
...
def a_psi(r):
    """Stabilized Psi-growth: center weak, outer region strong"""
    growth = 0.45 * np.tanh(r / 6)
    return 1.15 * fractal_backflow(r) * (1 + 0.4*vortex_distribution(r)) * (r+soft)**growth
...
print("\nKGT v4.13 — Stabilized Core Model")
